...
function createCalendar(elem, year, month, day) {
    ...
    cadena1 = ' Hoy es: '+day+'-'+month+'-'+year+'';
    //let table = cadena + '<table id="table"><tr><th>LU</th><th>MA</th><th>MI</th><th>JU</th><th>VI</th><th>SA</th><th>DO</th></tr><tr>';
    let meses = {
      '01': 'Enero',
      '02': 'Febrero',
      '03': 'Marzo',
    ...
    let table = '<table id="table" class="table-bordered"> <tr> <th colspan="7" style="text-align:center;">' + cadena + '</th> </tr> ' +
    '<tr><th>LU</th><th>MA</th><th>MI</th><th>JU</th><th>VI</th><th>SA</th><th>DO</th></tr><tr>';

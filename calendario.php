...
<header>   
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <!-- facebook -->
            <a href="https://www.facebook.com/?locale=es_ES" class="rrss"> 
            ...
            <!-- twitter -->
            <a href="https://twitter.com/?lang=es" class="rrss"> 
            ...
            <!-- instagram -->
            <a href="https://www.instagram.com/" class="rrss"> 
...
<div class="cuerpo">
  <div class="info"><br>
        ...
        <form action="" method="post" name="formularioCitasPrincipal" id="formularioCitasPrincipal"> <!-- formularioCitasPrincipal -->
            <input type="hidden" name="fechaEnCurso" id="fechaEnCurso" value="<?php echo($fechaEnCurso); ?>">
...
<script src="js/calendario.js"> createCalendar() </script>
